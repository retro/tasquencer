...
it('handles workflow completion in nested workflows', ({ expect }) => {
  const program = Effect.gen(function* () {
    ...
    yield* service.initializeWorkflow('t3', {});
    yield* service.initializeWorkflow('t3', {});
    ...
    yield* service.startWorkItem('t3.$subWorkflowId.subT1.$subT1WorkItemId', {
      params: { subWorkflowId, subT1WorkItemId },
    });
    ...
    yield* service.completeWorkItem('t2.$t2WorkItemId', {
      params: { t2WorkItemId: t2WorkItemId },
    });
